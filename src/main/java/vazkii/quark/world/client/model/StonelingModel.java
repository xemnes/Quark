...
public class StonelingModel extends EntityModel<StonelingEntity> {
	...
	public StonelingModel() {
		...
		// func_217178_a = addCuboid
		
		head.func_217178_a(null, -3.0F, -2.0F, -3.0F, 6, 8, 6, 0.0F, 0, 0);
		head.func_217178_a(null, -1.0F, -4.0F, -5.0F, 2, 4, 2, 0.0F, 8, 24);
		head.func_217178_a(null, -1.0F, 6.0F, -3.0F, 2, 2, 2, 0.0F, 16, 20);
		head.func_217178_a(null, -1.0F, -4.0F, 3.0F, 2, 4, 2, 0.0F, 0, 24);
		head.func_217178_a(null, -1.0F, -4.0F, -3.0F, 2, 2, 6, 0.0F, 16, 24);
		head.func_217178_a(null, -1.0F, -4.0F, -1.0F, 2, 2, 2, 0.0F, 24, 20);
		head.func_217178_a(null, -1.0F, 1.0F, -5.0F, 2, 2, 2, 0.0F, 18, 0);
		head.func_217178_a(null, -4.0F, -1.0F, -3.0F, 1, 2, 2, 0.0F, 0, 0);
		head.func_217178_a(null, 3.0F, -1.0F, -3.0F, 1, 2, 2, 0.0F, 0, 0);

		arm_right = new ModelRenderer(this);
		arm_right.setRotationPoint(-3.0F, 2.0F, 0.0F);
		setRotationAngle(arm_right, 3.1416F, 0.0F, 0.0F);
		body.addChild(arm_right);
		arm_right.func_217178_a(null, -2.0F, 0.0F, -1.0F, 2, 8, 2, 0.0F, 0, 14);

		arm_left = new ModelRenderer(this);
		arm_left.setRotationPoint(3.0F, 2.0F, 0.0F);
		setRotationAngle(arm_left, 3.1416F, 0.0F, 0.0F);
		body.addChild(arm_left);
		arm_left.func_217178_a(null, 0.0F, 0.0F, -1.0F, 2, 8, 2, 0.0F, 8, 14);

		leg_right = new ModelRenderer(this);
		leg_right.setRotationPoint(-2.0F, 4.0F, 0.0F);
		body.addChild(leg_right);
		leg_right.func_217178_a(null, -1.0F, 2.0F, -1.0F, 2, 4, 2, 0.0F, 16, 14);

		leg_left = new ModelRenderer(this);
		leg_left.setRotationPoint(1.0F, 4.0F, 0.0F);
		body.addChild(leg_left);
		leg_left.func_217178_a(null, 0.0F, 2.0F, -1.0F, 2, 4, 2, 0.0F, 24, 14);
	}

	@Override
	public void setAngles(StonelingEntity stoneling, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
