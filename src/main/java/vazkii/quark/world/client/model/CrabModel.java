...
public class CrabModel extends EntityModel<CrabEntity> {
	...
	public CrabModel() {
		...
		leftThigh1 = new RendererModel(this);
		...
		leftThigh2 = new RendererModel(this);
		...
		leftThigh3 = new RendererModel(this);
		...
		leftThigh4 = new RendererModel(this);
		...
		leftLeg4 = new RendererModel(this);
		...
		rightThigh1 = new RendererModel(this);
		...
		rightThigh2 = new RendererModel(this);
		...
		rightThigh3 = new RendererModel(this);
		...
		rightThigh4 = new RendererModel(this);
		...
		rightLeg4 = new RendererModel(this);
		...
		leftForearm = new RendererModel(this);
		...
		leftLowerClaw = new RendererModel(this);
		...
		rightForearm = new RendererModel(this);
		...
		rightLowerClaw = new RendererModel(this);
