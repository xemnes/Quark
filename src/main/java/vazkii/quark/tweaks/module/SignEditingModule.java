...
public class SignEditingModule extends Module {
	...
	public void onInteract(PlayerInteractEvent.RightClickBlock event) {
		...
		if(player instanceof ServerPlayerEntity && tile instanceof SignTileEntity && (!requiresEmptyHand || player.getHeldItemMainhand().isEmpty()) && player.canPlayerEdit(event.getPos(), event.getFace(), event.getItemStack()) && !event.getEntity().isSneaking()) {
