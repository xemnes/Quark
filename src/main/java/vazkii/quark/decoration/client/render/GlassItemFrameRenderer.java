...
public class GlassItemFrameRenderer extends EntityRenderer<GlassItemFrameEntity> {
    ...
    private static final ModelResourceLocation LOCATION_MODEL = new ModelResourceLocation(new ResourceLocation(Quark.MOD_ID, "glass_frame"), "map=false");
    private static final ModelResourceLocation LOCATION_MODEL_MAP = new ModelResourceLocation(new ResourceLocation(Quark.MOD_ID, "glass_frame"), "map=true");
    ...
    private void renderItem(GlassItemFrameEntity itemFrame) {
